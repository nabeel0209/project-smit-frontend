          ...
          <div className="w-full lg:w-1/2 space-y-8">
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-[#64748B] text-sm font-semibold">4.8k Students Enrolled</span>
              </div>
            </div>

            <div className="p-8 bg-white border border-[#D1FAE5] rounded-[32px] shadow-sm">
              <div className="flex flex-col mb-6">
                <span className="text-[11px] font-bold text-[#64748B] uppercase tracking-[0.2em] mb-1">Price</span>
                <span className="text-5xl font-black text-[#10B981]">${course.price}</span>
              </div>
              ...
              <p className="text-center text-[#64748B] text-xs mt-4 font-medium">30-Day Money-Back Guarantee</p>
            </div>
