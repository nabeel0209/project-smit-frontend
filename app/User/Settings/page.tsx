    ...
    <div className="max-w-5xl mx-auto pb-12">
      <div className="mb-8">
        ...
        <p className="text-text-muted mt-1">
          Manage your preferences and platform behavior.
        </p>
      </div>
            ...
            <div>
              ...
              <div className="space-y-1">
                ...
                <Row
                  ...
                  description="Invoices and billing confirmations"
                  right={<Toggle defaultOn />}
                />
                <Row
                  title="Promotions & offers"
                  description="Discounts and new course launches"
                  right={<Toggle />}
                />
                <Row
                  title="Weekly digest"
                ...
                <Row
                  ...
                  description="Reminders to continue your courses"
                  right={<Toggle defaultOn />}
                />
                <Row
                  title="Live sessions"
                  description="Alerts when a Q&A or live event starts"
                  right={<Toggle defaultOn />}
                />
                <Row
                ...
                <Row
                  ...
                  description="Badges, streaks, and certificates"
                  right={<Toggle defaultOn />}
                />
                <Row
                  title="Sound effects"
            ...
            <div>
              ...
              <div className="mt-5">
                <Row
                  ...
                  description="Translate course descriptions into your language"
                  right={<Toggle />}
                />
              </div>
            </div>
          ...
          {activeTab === "accessibility" && (
            <div>
              ...
              <div className="space-y-1">
                ...
                />
                <Row
                  title="Closed captions by default"
                  description="Auto-enable captions on video lessons"
                  right={<Toggle defaultOn />}
                />
                <Row
                ...
                {[
                  {
                    ...
                    desc: "Sync lesson deadlines to your calendar",
                    connected: true,
                  },
                  {
                    name: "Slack",
            ...
            <div>
              ...
              <div className="space-y-1">
                <Row
                  ...
                  description="Use activity to suggest courses"
                  right={<Toggle defaultOn />}
                />
                <Row
                ...
                <Row
                  ...
                  description="Share data with learning partners"
                  right={<Toggle />}
                />
              </div>
            ...
            <div>
              ...
              <div className="space-y-1">
                ...
                <Row
                  ...
                  description="Use GPU for video playback"
                  right={<Toggle defaultOn />}
                />
                <Row
                  title="Autoplay next lesson"
                  description="Automatically start the next video"
                  right={<Toggle defaultOn />}
                />
                <Row
                  title="Playback speed memory"
                  description="Remember your preferred video speed"
                  right={<Toggle defaultOn />}
                />
              </div>
